...
INCLUDERELATIONSFORCOMPUTEDCOLUMNS=${38}
...
PROFORCEONPARTIALCHANGES=${58}
PROGLOBALENDDELIMITER=${59}
PROGLOBALENDDELIMITERPRIORITIZED=${60}
PROLICENSEKEY=${61}
...
SEARCHPATH=${71}
SECUREPARSING=${72}
SHOULDGENERATECHECKSRUNREPORT=${73}
...
docker-entrypoint.sh "${GLOBALS[@]}" execute-sql "${PARAMS[@]}"
